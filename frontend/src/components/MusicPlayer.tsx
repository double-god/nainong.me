  ...
  useEffect(() => {
    ...
    if (isPlaying && currentTrack?.url) {
      if (!playStartTime) {
        ...
        console.log('🟢 MusicPlayer: 开始播放，设置 playStartTime =', startTime)
      ...
      audio.pause()
      if (!isPlaying) {
        console.log('🔄 MusicPlayer: 清除 playStartTime')
  ...
  useEffect(() => {
    ...
    const handleEnded = () => {
      ...
      if (audioRef.current) {
        ...
        console.log('✅ MusicPlayer: 重置完成，新的 playStartTime =', newStartTime)
      }
    }
